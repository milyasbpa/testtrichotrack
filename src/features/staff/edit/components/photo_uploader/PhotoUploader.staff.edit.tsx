...
import { PhotoEditorModalStaffEdit } from "../photo_editor_modal";
import { Avatar } from "src/core/ui/components/avatar";

export interface PhotoUploaderStaffEditProps {
  photo?: string;
  disabled?: boolean;
  cta?: {
    primary: {
...
export const PhotoUploaderStaffEdit = ({
  photo = "",
  disabled = false,
  cta = {
    primary: {
