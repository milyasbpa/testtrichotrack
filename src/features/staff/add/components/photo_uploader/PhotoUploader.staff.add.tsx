...
import { PhotoEditorModalStaffAdd } from "../photo_editor_modal";
import { Avatar } from "src/core/ui/components/avatar";

export interface PhotoUploaderStaffAddProps {
  photo?: string;
  disabled?: boolean;
  cta?: {
    primary: {
...
export const PhotoUploaderStaffAdd = ({
  photo = "",
  disabled = false,
  cta = {
    primary: {
