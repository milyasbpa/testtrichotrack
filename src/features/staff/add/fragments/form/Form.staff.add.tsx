...
import { PhotoUploaderStaffAdd } from "../../components/photo_uploader/PhotoUploader.staff.add";
import { useStaffAddGetOutlets } from "../../react_query/hooks/useGetOutlets.staff.add";
...
export const FormStaffAdd = () => {
  ...
  const { fetchNextPage: fetchNextPageOutlets } = useStaffAddGetOutlets();
  ...
  const handleUploadPhotoProfile = (data: string) => {
    dispatch({
      type: StaffAddActionEnum.ChangePhotoProfileValue,
      payload: data,
    });
  };
  ...
  return (
    ...
    >
          ...
          {appDictionaries.permission.staffs.items
            ...
            .map((item, index) => (
              <RadioButton
                ...
                disabled={appState.auth.role === "EMPLOYEE"}
      ...
      <Textfield
        ...
        placeholder={dictionaries.staff_position_input.placeholder}
