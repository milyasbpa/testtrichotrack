...
import { PhotoEditorModalOutletEdit } from "../photo_editor_modal/PhotoEditorModal.outlet.edit";
import SVGIcon from "src/core/ui/icons";

export interface PhotoUploaderOutletEditProps {
  photo?: string;
  label?: string;
  placeholder?: string;
  cta?: {
...
export const PhotoUploaderOutletEdit = ({
  photo = "",
  label = "",
  placeholder = "",
  cta = {
