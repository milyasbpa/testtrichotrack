...
import { useSpotlightScanAnotherConfirmationSetAllScanImageInvalid } from "./useSetAllScanImageInvalid.scan.spotlight_another_confirmation";
import { useSpotlightScanAnotherConfirmationSetPartialScanImageInvalid } from "./useSetPartialScanImageInvalid.spotlight_another_confirmation";
...
export const useSpotlightScanAnotherConfirmationScalpPostCases = () => {
  ...
  >({
    mutationKey: SpotlightScanAnotherConfirmationReactQueryKey.PostCases(),
    mutationFn: () => {
      const scans = [
