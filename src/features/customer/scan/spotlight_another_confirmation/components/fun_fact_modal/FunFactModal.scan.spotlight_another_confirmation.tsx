...
export interface FunFactModalSpotlightAnotherScanConfirmationProps {
  open?: boolean;
  message?: string;
  description?: string;
  item?: {
...
export const FunFactModalSpotlightAnotherScanConfirmation = ({
  open = false,
  message = "",
  description = "",
  item = {
...
}: FunFactModalSpotlightAnotherScanConfirmationProps) => {
  return (
