...
const canvasID = `usb-microscope-camera-scan-canvas__compulsory-retake-scan`;
const videoID = `usb-microscope-camera-scan-video__compulsory-retake-scan`;

export interface USBMicroscopeCameraCompulsoryScanRetakeProps {
  onClick?: (data: { image: string }) => void;
}

export const USBMicroscopeCameraCompulsoryScanRetake = ({
  onClick,
}: USBMicroscopeCameraCompulsoryScanRetakeProps) => {
