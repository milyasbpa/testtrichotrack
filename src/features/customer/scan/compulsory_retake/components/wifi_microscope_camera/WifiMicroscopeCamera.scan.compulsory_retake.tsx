...
export interface WifiMicroscopeCameraCompulsoryScanRetakeProps {
  image?: string;
  onCapture?: () => void;
}

export default function WifiMicroscopeCameraCompulsoryScanRetake({
  image = "",
  onCapture,
}: WifiMicroscopeCameraCompulsoryScanRetakeProps) {
  return (
    <div
      className={clsx(
