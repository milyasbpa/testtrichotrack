...
export interface WifiMicroscopeCameraSpotlightScanProps {
  image?: string;
  onCapture?: () => void;
}

export default function WifiMicroscopeCameraSpotlightScan({
  image = "",
  onCapture,
}: WifiMicroscopeCameraSpotlightScanProps) {
  return (
    <div
      className={clsx(
