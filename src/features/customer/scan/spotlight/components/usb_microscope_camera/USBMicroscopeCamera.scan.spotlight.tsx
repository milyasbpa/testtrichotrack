...
const canvasID = `usb-microscope-camera-scan-canvas__spotlight-scan`;
const videoID = `usb-microscope-camera-scan-video__spotlight-scan`;

export interface USBMicroscopeCameraSpotlightScanProps {
  onClick?: (data: { image: string }) => void;
}

export const USBMicroscopeCameraSpotlightScan = ({
  onClick,
}: USBMicroscopeCameraSpotlightScanProps) => {
