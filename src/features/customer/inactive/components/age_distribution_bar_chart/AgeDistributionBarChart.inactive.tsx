...
const ageDistributionLabels = {
  id: "ageDistributionLabels",
  afterDatasetsDraw(chart: any) {
    const { ctx } = chart;

    if (chart.canvas.id === "age-distribution-chart") {
...
export interface IAgeDistributionBarChartInactiveProps {
  labels?: string[];
  data?: number[];
}

export const AgeDistributionBarChartInactive = ({
  labels = [],
  data = [],
}: IAgeDistributionBarChartInactiveProps) => {
  const options = {
    type: "bar",
