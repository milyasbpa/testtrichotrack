...
export interface LineChartLegendDiagnosisProps {
  title?: string;
  data?: {
    id: string;
    name: string;
...
export const LineChartLegendDiagnosis = ({
  title = "",
  data = [],
}: LineChartLegendDiagnosisProps) => {
  const groupNumber = 2;
  return (
    <div
      className={clsx(
            ...
            {data
              ...
              .map((item, index) => (
                ...
                >
                  ...
                  <p
                    className={clsx(
                      "text-[1rem] text-white-80 font-regular text-left"
                    )}
                  >
                    {item.name}
                  </p>
