...
export interface QuestionnaireOpenQuestionCustomerQuestionnaireProps {
  id?: number;
  number?: number;
  title?: string;
  type?: string;
...
export const QuestionnaireOpenQuestionCustomerQuestionnaire = ({
  id = 0,
  number = 0,
  title = "",
  answer,
  onAnswer = () => {},
}: QuestionnaireOpenQuestionCustomerQuestionnaireProps) => {
  // const { questionnaire } = useCustomerCustomerQuestionnaireTranslator();
  const value = useMemo(() => {
