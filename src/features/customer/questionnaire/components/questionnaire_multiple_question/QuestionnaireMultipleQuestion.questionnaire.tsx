...
export interface QuestionnaireMultipleQuestionCustomerQuestionnaireProps {
  id?: number;
  number?: number;
  options?: string[];
  maskOptions?: string[];
...
export const QuestionnaireMultipleQuestionCustomerQuestionnaire = ({
  id = 0,
  number = 0,
  options = [],
  maskOptions = [],
  ...
  answer,
  onAnswer = () => {},
}: QuestionnaireMultipleQuestionCustomerQuestionnaireProps) => {
