...
export interface IQuestionnaireSingleQuestionRegistrationProps {
  id?: number;
  number?: number;
  options?: string[];
  maskOptions?: string[];
...
export const QuestionnaireSingleQuestionRegistration = ({
  id = 0,
  number = 0,
  options = [],
  maskOptions = [],
  ...
  answer,
  onAnswer = () => {},
}: IQuestionnaireSingleQuestionRegistrationProps) => {
