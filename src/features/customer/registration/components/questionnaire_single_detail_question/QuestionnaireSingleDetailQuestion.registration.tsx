...
export interface QuestionnaireSingleDetailRegistrationProps {
  id?: number;
  number?: number;
  options?: string[];
  maskOptions?: string[];
...
export const QuestionnaireSingleDetailRegistration = ({
  id = 0,
  number = 0,
  options = [],
  maskOptions = [],
  ...
  answer,
  onAnswer = () => {},
}: QuestionnaireSingleDetailRegistrationProps) => {
