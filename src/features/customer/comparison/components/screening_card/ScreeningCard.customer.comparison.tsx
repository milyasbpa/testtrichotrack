...
export interface ScreeningCardCustomerComparisonProps {
  name?: string;
  value?: string;
  description?: string;
...
export const ScreeningCardCustomerComparison = ({
  name = "",
  value = "",
  description = "",
  children,
}: ScreeningCardCustomerComparisonProps) => {
  return (
    <Card elevation="1" className={clsx("h-full", "!rounded-[0.5rem]")}>
      <div
        className={clsx(
