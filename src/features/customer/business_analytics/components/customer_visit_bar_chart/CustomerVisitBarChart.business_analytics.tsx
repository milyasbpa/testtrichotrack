...
const customerVisitLabels = {
  id: "customerVisitLabels",
  afterDatasetsDraw(chart: any) {
    const { ctx } = chart;

    if (chart.canvas.id === "customer-visit-chart") {
...
export interface CustomerVisitBarChartBusinessAnalyticsProps {
  labels?: string[];
  data?: number[];
}

export const CustomerVisitBarChartBusinessAnalytics = ({
  labels = [],
  data = [],
  ...
  return (
    <Bar id={"customer-visit-chart"} options={options as any} data={chartData} />
  );
};
