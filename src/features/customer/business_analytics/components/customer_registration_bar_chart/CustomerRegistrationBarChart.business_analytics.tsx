...
const customerRegistrationLabels = {
  id: "customerRegistrationLabels",
  afterDatasetsDraw(chart: any) {
    const { ctx } = chart;

    if (chart.canvas.id === "customer-registration-chart") {
...
export interface CustomerRegistrationBarChartBusinessAnalyticsProps {
  labels?: string[];
  data?: number[];
}

export const CustomerRegistrationBarChartBusinessAnalytics = ({
  labels = [],
  data = [],
  ...
  return (
    <Bar
      id={"customer-registration-chart"}
